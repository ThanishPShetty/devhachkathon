...
openai.api_key = "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"
...
def generate_text(course):
    palm.configure(api_key="AIzaSyAIwyd5EaTJhJOOpiEhGvgU7WXtikgdHCY")
    models = [
